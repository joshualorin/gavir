...
gavi_pal <- list(
  ...
  `vaccine` = gavi_colors("cholera", "ebola", "hepb", "hpv", "ipv", "je", "malaria", "mcv", "mr", "mena", "penta", "pcv", "rota", "tcv", "yf","td","rabies"),
  `who_region` = gavi_colors("afro", "emro", "euro", "paho", "searo", "wpro"),
  `gavi_segment`= gavi_colors("core", "fragile", "high impact", "never gavi mics", "non gavi", "former gavi mics"),
